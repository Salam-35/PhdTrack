...
//   const handleSave = (university: University) => {
//     if (editingUniversity) {
//       setUniversities(universities.map((uni) => (uni.id === university.id ? university : uni)))
//     } else {
//       setUniversities([university, ...universities])
//     }
...
export default function Applications({ universities, setUniversities }: ApplicationsProps) {
  ...
  try {
    ...
    if (isEditing) {
      ...
      setUniversities([result, ...universities]) // ✅ This now includes full returned row
    }
